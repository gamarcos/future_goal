...
import br.com.gabrielmarcos.register.home.ui.HomeGoalsFragment_MembersInjector;
...
public final class DaggerHomeGoalsComponent implements HomeGoalsComponent {
  ...
  private void initialize(final HomeGoalsModule homeGoalsModuleParam,
    ...
    this.providesHomeGoalsViewModelProvider = DoubleCheck.provider(HomeGoalsModule_ProvidesHomeGoalsViewModelFactory.create(homeGoalsModuleParam, goalDatabaseRepositoryProvider));
